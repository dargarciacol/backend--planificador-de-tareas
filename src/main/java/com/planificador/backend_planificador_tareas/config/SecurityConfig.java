...
import com.planificador.backend_planificador_tareas.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll() // <-- 2. PERMITIR PREFLIGHT OPTIONS
                        .requestMatchers("/api/auth/**", "/api/users/register", "/api/users/login", "/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html").permitAll()
